...
namespace CloudOnce
{
    ...
    {
        private static readonly CloudString s_savedGameData = new CloudString("savedGameData", PersistenceType.Latest, "");

        public static string savedGameData
        {
            get { return s_savedGameData.Value; }
            set { s_savedGameData.Value = value; }
        }
    }
}
